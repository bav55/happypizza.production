                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="part_1" placeholder="1 порция" required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="part_2" placeholder="2 порция" required>
                                </div>
                            </div>
                        </div>
