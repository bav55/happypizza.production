...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('action.edit', $action->id) }}">{{ $action->title }}</a></li>
    </ol>

    <form action="{{ route('action.update', $action->id) }}" enctype="multipart/form-data" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="row">
                            <div class="form-check col-3">
                                <label class="form-check-label"><input type="radio" class="form-check-input" name="is_percent" id="is_present" value="true" {{ $action->is_percent == 1 ? 'checked' : '' }}> Да</label>
                            </div>
                            <div class="form-check col-3">
                                <label class="form-check-label"><input type="radio" class="form-check-input" name="is_percent" id="is_present" value="false" {{ $action->is_percent == 0 ? 'checked' : '' }}> Нет</label>
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="row">
                            <div class="form-check col-3">
                                <label class="form-check-label"><input type="radio" class="form-check-input" name="is_present" id="is_percent" value="true" {{ $action->is_present == 1 ? 'checked' : '' }}> Да</label>
                            </div>
                            <div class="form-check col-3">
                                <label class="form-check-label"><input type="radio" class="form-check-input" name="is_present" id="is_percent" value="false" {{ $action->is_present == 0 ? 'checked' : '' }}> Нет</label>
                            </div>
                        </div>
                    </fieldset>
                </div>
